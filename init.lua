--[[
  ...
  Initialized by Kickstart.nvim (https://github.com/nvim-lua/kickstart.nvim)
  Customized by bnjmn (https://github.com/bnjmn)
...
vim.opt.listchars = "nbsp:ϟ,eol:¬,tab:▸ ,trail:•,extends:»,precedes:«"
